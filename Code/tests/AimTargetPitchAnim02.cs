...
public sealed class AimTargetPitchAnim02 : Component
{
  ...
  [Property] public String AttachName { get; set; } = "arm_r_pitch";
  ...
  protected override void OnUpdate()
  {
    ...
    var attachmentBone = Model.GetAttachmentObject(AttachName);
    if (attachmentBone == null) return;
    ...
    if ( DidHit ){
      ...
      Vector3 dir = (finalAimPosition - attachmentBone.WorldPosition).Normal;
